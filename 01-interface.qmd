...
-   Load one of the three example to see an example of Arabesque in use.
...
-   The **right panel** is for filtering the flow data set.
...
See [filtering flow data section](docs/07-filtering-flowdata.html).
