...
Arabesque also allows you to import your own data sets :

\(1\) at least a flowdata file in the form of an origin-destination matrice

\(2\) a nodes file.

For this tutorial, we will use for example the historical trade flows listed in the MOBSOL file. For more informations about this dataset see in arabesque-examples.

In Arabesque2, you have to import your nodes firstly.
