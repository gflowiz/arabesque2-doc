...
## Types of actions on a layer displayed

Several actions can be performed on all the layer level displayed, via the layer management section using icon-buttons.
