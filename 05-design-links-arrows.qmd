...
The outline of the lines or arro

ws can be modified: their color and their thickness (between 0 and 1 px).
...
The transparency can be parameterized according to four scales: linear, square, square root and logarithmic.
