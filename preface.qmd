...
Arabesque is part of the geographic flow vizualisation (gflowiz) project, led by Françoise BAHOKEN (Univ. Gustave Eiffel) and Étienne CÔME (Univ. Gustave Eiffel), with the scientific collaboration of Laurent JÉGOU (Univ. Toulouse 2 Jean Jaurès).

\- Thomas BAPAUME (ESIEE student engineer), was the main developer of the first version of *Arabesque*, then Paul FABRE (Univ. Gustave Eiffel/IGN student geographer/geomatician).\
- Tony HAUCK (freelance geomatician) is developping the *Arabesque 2* version.\
- Luis Daniel MEDINA ZULUAGA (research engineer, CorText, Univ. Gustave Eiffel) for contributions to development

Other contributors include,\
- Marion MAISONOBE and Grégoire LE CAMPION (CNRS), for the conception & design ;\
- Nicolas ROELANDT (Univ. Gustave Eiffel), for the first documentation bookdown ;\
- as well as Anne-Christine BRONNER, Nicolas LAMBERT, Mathieu MERLET, Julie PIERSON, Matthieu RAJERISON and Cédric RIDEL for the initial users tests.
